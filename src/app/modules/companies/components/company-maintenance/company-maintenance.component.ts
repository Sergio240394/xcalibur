...
export class CompanyMaintenanceComponent implements OnInit {
  ...
  private loadPaises(): void {
    ...
    const url = `${environment.apiUrl}/GetCEGepais?pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private loadCiudades(): void {
    ...
    // Construir la URL con los parámetros
    const url = `${environment.apiUrl}/GetCEGeciudad?pcPais=${paisCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private loadZonas(): void {
    ...
    // Construir la URL con los parámetros
    const url = `${environment.apiUrl}/GetCEZona?pcCompania=${companiaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private loadLocalidades(): void {
    ...
    // Construir la URL con los parámetros
    const url = `${environment.apiUrl}/GetCELocalidad?pcCompania=${companiaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private loadNegocios(): void {
    ...
    // Construir la URL con los parámetros
    const url = `${environment.apiUrl}/GetCEGenegocio?pcCompania=${companiaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private loadMonedas(): void {
    ...
    // Construir la URL con los parámetros
    const url = `${environment.apiUrl}/GetCEgemoneda?pcCompania=${companiaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private loadCobradores(): void {
    ...
    // Construir la URL con los parámetros
    const url = `${environment.apiUrl}/GetCECobrador?pcCompania=${companiaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private loadClasificVentas(): void {
    ...
    // Construir la URL con los parámetros
    const url = `${environment.apiUrl}/GetCEClasifVenta?pcCompania=${companiaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private loadClasifXCobros(): void {
    ...
    // Construir la URL con los parámetros
    const url = `${environment.apiUrl}/GetCEClasifCobro?pcCompania=${companiaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private loadCausasSusp(): void {
    ...
    // Construir la URL con los parámetros
    const url = `${environment.apiUrl}/GetCECausasusp?pcCompania=${companiaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private loadLosLineServices(): void {
    ...
    // Construir la URL con los parámetros
    const url = `${environment.apiUrl}/GetCEcctabla1?pcCompania=${companiaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private loadSubLosSubLines(): void {
    ...
    // Construir la URL con los parámetros
    const url = `${environment.apiUrl}/GetCEcctabla2?pcCompania=${companiaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private loadProductGroups(): void {
    ...
    // Construir la URL con los parámetros
    const url = `${environment.apiUrl}/GetCEcctabla3?pcCompania=${companiaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private loadAffinities(): void {
    ...
    // Construir la URL con los parámetros
    const url = `${environment.apiUrl}/GetCEcctabla4?pcCompania=${companiaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private loadTransportes(): void {
    ...
    // Construir la URL con los parámetros
    const url = `${environment.apiUrl}/GetCETransporte?pcCompania=${companiaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private loadRutas(): void {
    ...
    // Construir la URL con los parámetros
    const url = `${environment.apiUrl}/GetCERuta?pcCompania=${companiaCode}&pcTransporte=${transporteCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private loadSectores(): void {
    ...
    // Construir la URL con los parámetros
    const url = `${environment.apiUrl}/GetCESector?pcCompania=${companiaCode}&pcTransporte=${transporteCode}&pcRuta=${rutaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private loadTipoClientes(): void {
    ...
    // Construir la URL con los parámetros
    const url = `${environment.apiUrl}/GetCETipoCliente?pcCompania=${companiaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private lookupPais(): void {
    ...
    const url = `${environment.apiUrl}/GetLeavePais?pcPais=${paisCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private lookupCiudad(): void {
    ...
    const url = `${environment.apiUrl}/GetLeaveCiudad?pcPais=${paisCode}&pcCiudad=${ciudadCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private lookupZona(): void {
    ...
    const url = `${environment.apiUrl}/GetLeaveZona?pcCompania=${companiaCode}&pcZona=${zonaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private lookupLocalidad(): void {
    ...
    const url = `${environment.apiUrl}/GetLeaveLocalidad?pcCompania=${companiaCode}&pcLocalidad=${localidadCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private lookupNegocio(): void {
    ...
    const url = `${environment.apiUrl}/GetLeaveNegocio?pcCompania=${companiaCode}&pcNegocio=${negocioCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private lookupMoneda(): void {
    ...
    const url = `${environment.apiUrl}/GetLeaveMoneda?pcMoneda=${monedaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private lookupCobrador(): void {
    ...
    const url = `${environment.apiUrl}/GetLeaveCobrador?pcCompania=${companiaCode}&pcCobrador=${cobradorCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private lookupClasificVenta(): void {
    ...
    const url = `${environment.apiUrl}/GetLeaveClasifVenta?pcCompania=${companiaCode}&pcClaven=${clasificVentaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private lookupClasifXCobro(): void {
    ...
    const url = `${environment.apiUrl}/GetLeaveClasifCobro?pcCompania=${companiaCode}&pcClacob=${clasifXCobroCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private lookupCausaSusp(): void {
    ...
    const url = `${environment.apiUrl}/GetLeaveCausaSusp?pcCompania=${companiaCode}&pcCausaSus=${causaSuspCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private lookupLosLineService(): void {
    ...
    const url = `${environment.apiUrl}/GetLeavecctabla1?pcCompania=${companiaCode}&pcCodigoC1=${losLineServiceCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private lookupSubLosSubLine(): void {
    ...
    const url = `${environment.apiUrl}/GetLeavecctabla2?pcCompania=${companiaCode}&pcCodigoC2=${subLosSubLineCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private lookupProductGroup(): void {
    ...
    const url = `${environment.apiUrl}/GetLeavecctabla3?pcCompania=${companiaCode}&pcCodigoC3=${productGroupCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private lookupAffinity(): void {
    ...
    const url = `${environment.apiUrl}/GetLeavecctabla4?pcCompania=${companiaCode}&pcCodigoC4=${affinityCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private lookupTransporte(): void {
    ...
    const url = `${environment.apiUrl}/GetLeaveTransporte?pcCompania=${companiaCode}&pcTransporte=${transporteCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private lookupRuta(): void {
    ...
    const url = `${environment.apiUrl}/GetLeaveRuta?pcCompania=${companiaCode}&pcTransporte=${transporteCode}&pcRuta=${rutaCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private lookupSector(): void {
    ...
    const url = `${environment.apiUrl}/GetLeaveSector?pcCompania=${companiaCode}&pcTransporte=${transporteCode}&pcRuta=${rutaCode}&pcSector=${sectorCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
  ...
  private lookupTipoCliente(): void {
    ...
    const url = `${environment.apiUrl}/GetLeaveTipoCliente?pcCompania=${companiaCode}&pcTipocli=${tipoClienteCode}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper || false}&pcToken=${currentUser.pcToken}`;
