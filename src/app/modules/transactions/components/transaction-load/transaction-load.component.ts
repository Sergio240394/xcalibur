...
export class TransactionLoadComponent implements OnInit {
  ...
  loadEmpresasCxC(): void {
    ...
    if (!currentUser || !currentUser.pcToken || !currentUser.pcLogin || !currentUser.pcSuper || !companiaValue) {
  ...
  validateCompaniaByCode(): void {
    ...
    console.log('📊 Datos obtenidos:', {
      ...
      hasSuper: !!currentUser?.pcSuper
    });

    if (!companiaValue || !currentUser || !currentUser.pcToken || !currentUser.pcLogin || !currentUser.pcSuper) {
    ...
    const fullUrl = `${baseUrl}${endpoint}?pcCompania=${companiaValue}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper}&pcToken=${currentUser.pcToken}`;

    console.log('🚀 ENTER presionado en campo compañía - Llamando endpoint:');
  ...
  validateFecPer(): void {
    ...
    if (!fecPerValue || !companiaValue || !currentUser || !currentUser.pcToken || !currentUser.pcLogin || !currentUser.pcSuper) {
      return;
    }
    ...
    const fullUrl = `${baseUrl}${endpoint}?pcCompania=${companiaValue}&pcFechaPeriodo=${fecPerValue}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper}&pcToken=${currentUser.pcToken}`;

    console.log('🚀 ENTER/BLUR en campo fecha per - Llamando endpoint:');
    console.log('📍 Endpoint:', endpoint);
    console.log('🌐 URL completa:', fullUrl);
    console.log('📊 Datos enviados:', {
      pcCompania: companiaValue,
      pcFechaPeriodo: fecPerValue,
      pcLogin: currentUser.pcLogin,
      pcSuper: currentUser.pcSuper,
      pcToken: currentUser.pcToken
    });
  ...
  validateLote(): void {
    ...
    if (!loteValue || !companiaValue || !fecPerValue || !currentUser || !currentUser.pcToken || !currentUser.pcLogin || !currentUser.pcSuper) {
      return;
    }
    ...
    const fullUrl = `${baseUrl}${endpoint}?pcCompania=${companiaValue}&pcFechaPer=${fecPerValue}&pcLote=${loteValue}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper}&pcToken=${currentUser.pcToken}`;

    console.log('🚀 ENTER/BLUR en campo lote - Llamando endpoint:');
    console.log('📍 Endpoint:', endpoint);
    console.log('🌐 URL completa:', fullUrl);
    console.log('📊 Datos enviados:', {
      pcCompania: companiaValue,
      pcFechaPer: fecPerValue,
      pcLote: loteValue,
      pcLogin: currentUser.pcLogin,
      pcSuper: currentUser.pcSuper,
      pcToken: currentUser.pcToken
  ...
  private searchUbicacion(): void {
    ...
    console.log('📋 Cuenta:', cuentaValue);
    console.log('👤 Usuario:', {
      login: currentUser.pcLogin,
      super: currentUser.pcSuper,
      token: currentUser.pcToken
    });
  ...
  private searchCCosto(): void {
    ...
    console.log('📋 Centro de Costo:', cCostoValue);
    console.log('📋 Compañía:', companiaValue);
    console.log('📋 Cuenta:', cuentaValue);
    console.log('👤 Usuario:', {
      login: currentUser.pcLogin,
  ...
  private searchUFondo(): void {
    ...
    console.log('🔍 === BUSCANDO FONDO ===');
    console.log('📋 Fondo:', uFondoValue);
    console.log('📋 Compañía:', companiaValue);
    console.log('📋 Cuenta:', cuentaValue);
    console.log('👤 Usuario:', {
      login: currentUser.pcLogin,
  ...
  validateEmpresaByCode(): void {
    ...
    if (!empresaValue || !companiaValue || !currentUser || !currentUser.pcToken || !currentUser.pcLogin || !currentUser.pcSuper) {
      return;
    }
    ...
    const fullUrl = `${baseUrl}${endpoint}?pcCompania=${companiaValue}&pcEmpresa=${empresaValue}&pcLogin=${currentUser.pcLogin}&pcSuper=${currentUser.pcSuper}&pcToken=${currentUser.pcToken}`;

    console.log('🚀 ENTER/BLUR en campo empresa - Llamando endpoint:');
    console.log('📍 Endpoint:', endpoint);
    console.log('🌐 URL completa:', fullUrl);
    console.log('📊 Datos enviados:', {
      pcCompania: companiaValue,
      pcEmpresa: empresaValue,
      pcLogin: currentUser.pcLogin,
      pcSuper: currentUser.pcSuper,
      pcToken: currentUser.pcToken
    });
  ...
  validateTipoDocByCode(): void {
    ...
    if (!tipoDocValue || !companiaValue || !empresaValue || !numDocValue || !currentUser || !currentUser.pcToken || !currentUser.pcLogin || !currentUser.pcSuper) {
  ...
  loadDocumentosCxC(): void {
    ...
    if (!currentUser || !currentUser.pcToken || !currentUser.pcLogin || !currentUser.pcSuper || !companiaValue || !empresaValue) {
  ...
  validateFechaEmision(): void {
    ...
    if (!companiaValue || !fechaPerValue || !empresaValue || !currentUser || !currentUser.pcToken || !currentUser.pcLogin || !currentUser.pcSuper) {
  ...
  validateFechaVencimiento(): void {
    ...
    if (!companiaValue || !fechaEmisionValue || !currentUser || !currentUser.pcToken || !currentUser.pcLogin || !currentUser.pcSuper) {
  ...
  validateAplicaDoc(): void {
    ...
    console.log('🔍 Validando aplicación documento:', {
      aplicaDoc: aplicaDocValue,
      compania: companiaValue,
      empresa: empresaValue,
    ...
    if (!companiaValue || !empresaValue || !documentoValue || !tipoDocValue || !currentUser || !currentUser.pcToken || !currentUser.pcLogin || !currentUser.pcSuper) {
  ...
  validateMonto(): void {
    ...
    if (!companiaValue || !monedaValue || !tipoDocValue || !fechaEmisionValue || !currentUser || !currentUser.pcToken || !currentUser.pcLogin || !currentUser.pcSuper) {
